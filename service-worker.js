...
const APP_ASSETS = [
  ...
  "./assets/settings-app-card.svg",
  "./assets/settings-cycle-card.svg",
  "./assets/settings-program-card.svg",
  "./assets/settings-editor-card.svg",
  "./assets/settings-alerts-card.svg",
  "./assets/settings-data-card.svg",
];
